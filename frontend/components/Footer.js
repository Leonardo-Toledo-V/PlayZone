...
function Footer() {
	return (
		<>
			<div className="bg-slate-800 h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-20">
				<div className="p-5">
					<ul>
			...
			<div className="flex flex-col justify-center items-center text-center p-4 bg-slate-600">
